...
@onready var outlineMesh: MeshInstance3D = $Empty_014/NurbsPath_001/MeshInstance3D
@onready var outlineMesh2: MeshInstance3D = $Empty_014/Sphere_002/MeshInstance3D
@onready var collisionShape: CollisionShape3D = $CollisionShape3D

@onready var wholeitem: Node3D = $Empty_014

@onready var cursedmarking: Decal = $Empty_014/CursedMarking
var cursed = false
...
func _process(delta):
	...
	if selected:
		wholeitem.position.y = outlineWidth
