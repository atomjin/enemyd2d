...
@onready var item: MeshInstance3D = $boxGift1
@onready var outlineMesh: MeshInstance3D = $boxGift1/MeshInstance3D
@onready var collisionShape: CollisionShape3D = $CollisionShape3D

@onready var cursedmarking: Decal = $boxGift1/CursedMarking
var cursed = false
